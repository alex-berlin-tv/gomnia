...
// The API of omnia differentiates API endpoints into multiple classes. The URL-structure of
// the endpoints greatly differ between the different classes of endpoints. This interface
